...
import cie10DB from '../../data/cie10-array.json'
...
export default class CIE10 extends Component {
  ...
  handleCIE10ItemClick = cie10Item => {
    const CIE10AddedItems = [...this.state.CIE10AddedItems, cie10Item]
  ...
  handleDelete = itemToDelete => {
    const newAddedItems = this.state.CIE10AddedItems.filter(
      addedItem => {
  ...
  render() {
    ...
    return (
      <div className="diagnostic-impression">
        ...
        />
        {cie10Rows.length ? <h4>Impresiones:</h4> : null}
        <div>{cie10Rows}</div>
